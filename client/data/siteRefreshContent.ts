...
export const siteRefreshMeta: SiteRefreshMeta = {
  ...
  "updatedAtLabel": "September 21, 2026"
};
...
> = {
  "/ai-playground": {
    ...
    "description": "Explore real‑time generators for image synthesis, language reasoning, and agent behavior, and see the newest product launches—Cursor 3, Runway Fund, OpenAI Deep Research, Claude Opus 4.5, and ChatGPT—highlighted in our weekly radar.",
    "chips": [
