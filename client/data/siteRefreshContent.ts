...
export const siteRefreshMeta: SiteRefreshMeta = {
  ...
  "updatedAtLabel": "September 14, 2026"
};
...
> = {
  "/ai-playground": {
    ...
    "description": "Discover real‑time generators for image synthesis, language reasoning, and agent behavior, and see the newest product launches—Cursor 3, Runway Fund, OpenAI Deep Research, Claude Opus 4.5, and ChatGPT—highlighted in our weekly radar.",
    "chips": [
  ...
  "/ai-tools": {
    ...
    "description": "Twenty profession playbooks, each naming the one tool worth adopting first, the alternatives worth watching, and the adoption and time-saved signals behind the call — every entry linked to an official source.",
    "chips": [
  ...
  "/ai-projects": {
    ...
    "description": "A library of project blueprints, each a complete build sheet: numbered steps, a recommended stack, the papers behind the technique, curated resources, and starter code — plus a featured interactive course and weekly build-now tracks.",
    "chips": [
