...
> = {
  ...
  "/ai-tools": {
    ...
    "description": "Browse tools organized by profession, see the latest launches—Cursor 3, Runway Fund, OpenAI Deep Research, Claude Opus 4.5, and ChatGPT—and use‑case framing, and filter by impact to find the right solution fast.",
    "chips": [
